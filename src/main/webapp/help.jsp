...
<%@ page import="com.Medicare.Capstone_Project.connection.*"%>
 ...
 %>
	...
	<div class="contact">
		<div class="container">
			...
			<p>
			<h4>Are you facing trouble while ordering. Please Let us know</h4>
			</p>
			<br>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-user'>&nbsp;&nbsp;Medicare Support</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-envelope'>&nbsp;&nbsp;Medicare@support.com</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-phone'>&nbsp;&nbsp;1234567890.</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">"We are always happy to help."</h4>
			</div>
		</div>
	</div>
	<!-- //contact -->
